      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                        child: smallLabel("To",
                                            widget.parcelModel.receiverName)),
                                  )
                                ],
                              ),
                              SizedBox(
            ...
            //label("Reciver Name: ", widget.parcelModel.receiverName),
            //label("Reciver Address: ", widget.parcelModel.address),
            //label("Reciver Contact: ", widget.parcelModel.recieverNum),
            const SizedBox(
              height: 12,
            ),
